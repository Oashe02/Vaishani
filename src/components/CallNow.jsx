  ...
  return (
    <div className="fixed bottom-8 left-8 z-50">
      ...
      <button
        ...
        className="relative bg-gradient-to-r from-amber-500 to-yellow-400 rounded-full p-4 shadow-xl hover:shadow-2xl hover:from-amber-400 hover:to-yellow-300 transition-all duration-300 flex items-center justify-center"
        style={{ boxShadow: '0 10px 25px -5px rgba(245, 158, 11, 0.5)' }}
        aria-label="Contact Us"
      >
        <span className="absolute w-full h-full rounded-full animate-ping opacity-30 bg-amber-400"></span>
        <Phone className="text-white w-6 h-6 z-10" />
      </button>
